...
SCENARIO_FILE=$DRIVING_TEST_ROOT/data/leaderboard/leaderboard_Town0"$SCENARIO".json
...
if [ "$SAVE_DRIVING_VISION" = "true" ]; then
    echo "Saving driving vision! Results will be found in $DATASET_PATH/driving_record/leaderboard/leaderboard_Town0"$SCENARIO"..."
